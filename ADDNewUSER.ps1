...
function GLOBAL:Get-DeclaringVariablesGroupAndAccountEnte {
    ...
    $GLOBAL:SamAccountUser = ($Firstname[0] + $LastnameChar8).ToLower()
    $GLOBAL:SamAccountUserEmail = ($Firstname[0] + "." + $Lastname).ToLower()
}
...
function GLOBAL:Get-DeclaringVariablesGroupAndAccountD2s {
    ...
    $LastnameChar8 = $Lastname[0..6] -join ''
    $GLOBAL:SamAccountUser = ($Firstname + $LastnameChar8).ToLower()
...
function GLOBAL:Get-AddUserToGroupMember {
...
function GLOBAL:Set-CredentialAD {
...
function GLOBAL:Get-CheckInputData {
    ...
    try {
        if ($AccountExpirationDate -ne "n") {
            $GLOBAL:ExpirationDateOneDay = [DateTime]::Parse($AccountExpirationDate).AddDays(1)
        }
    }
...
$mxCoigAccount = $(Write-Host "Smarter-Mail: Utworzyć konto $SamAccountUserEmail ? T [Tak]: " -ForegroundColor DarkYellow -NoNewline; Read-Host)
    ...
    if ($mxCoigAccount -eq "t") {
        ...
        $jsonData = @{
            ...
            "forwardList" = @{
                "forwardList" = @($exchangeOwaAddress)
                "keepRecipients" = $true
        ...
        # Convert the JSON data to a JSON string using UTF-8 encoding 
        ...
        $apiUrl = 'https://mx.coig.pl/api/v1/settings/domain/user-put'
...
if ($Company -in 1..8) {}
    ...
    $GLOBAL:Pass = Get-RandomPassword 16
    ...
    Get-AddNewUser -StreetAddress "Berbeckiego 6" -City "Gliwice" -Company "WASKO S.A." -PostalCode "44-100" -Server "wasko.pl" -DomainMail "wasko.pl" -Department "$Department" -Description "$Department, $Firstname $Lastname" -mainPath "$mainpath"
    ...
    Get-CheckInputData
    Get-ChoiseManagerInOrganizationUnit -Server "wasko.pl" -pathOU "OU=WASKO, DC=wasko, DC=pl"
    Get-AddNewUser -StreetAddress "Płowiecka 105/107"  -City "Warszawa" -Company "WASKO S.A." -PostalCode "44-100" -DomainMail "wasko.pl" -Department "$Department" -Description "$Department, $Firstname $Lastname" -mainPath "$mainpath" 
    Get-AddUserToGroupMember
    Get-WriteToFileNewUsersList -Domain "DOMENA-WASKO" -DomainMail "wasko.pl"
    Set-CredentialMxCoig -Target "mxwasko"
    Get-AddNewAccountSmarterMail -enableMailForwarding "false" -owaDomainAddress "owa.wasko.pl"
    ...
    Get-CheckInputData
    Get-ChoiseManagerInOrganizationUnit -Server "wasko.pl" -pathOU "OU=WASKO, DC=wasko, DC=pl"
    Get-AddNewUser -StreetAddress "Czackiego 7/9/11" -City "Warszawa" -Company "WASKO S.A." -PostalCode "04-501" -Server "DOMENA-WASKO" -DomainMail "wasko.pl" -Department "$Department" -Description "$Department, $Firstname $Lastname" -mainPath "$mainpath"
    Get-AddUserToGroupMember
    Get-WriteToFileNewUsersList -Domain "DOMENA-WASKO" -DomainMail "wasko.pl"
    Set-CredentialMxCoig -Target "mxwasko"
    Get-AddNewAccountSmarterMail -enableMailForwarding "false" -owaDomainAddress "owa.wasko.pl"
    ...
    Get-CheckInputData
    Get-ChoiseManagerInOrganizationUnit -Server "wasko.pl" -pathOU "OU=WASKO, DC=wasko, DC=pl"
    Get-AddNewUser -Server "WINCOIG" -DomainMail "coig.pl" -mainPath "$mainpath"
    Get-AddUserToGroupMember
    ...
    Get-AddNewAccountSmarterMail -enableMailForwarding "true" -owaDomainAddress "owa.ente.com.pl" -isEnabled "false" -maxMailboxSize "52428800"
    ...
    Get-AddNewAccountSmarterMail -enableMailForwarding "true" -owaDomainAddress "mx.fonon.com.pl" -isEnabled "false" -maxMailboxSize "52428800"
    ...
    Get-CheckInputData
    Get-ChoiseManagerInOrganizationUnit -Server "wasko.pl" -pathOU "OU=WASKO, DC=wasko, DC=pl"
    Get-AddNewUser -StreetAddress "Czackiego 7/9/11" -City "Warszawa" -Company "D2S sp. z o.o." -PostalCode "00-043" -Department "D2S" -Server "wasko.pl" -DomainMail "de2es.pl" -Description "D2S, $Firstname $Lastname" -mainPath "$mainpath"
    Get-AddUserToGroupMember
    Get-WriteToFileNewUsersList -Domain "DOMENA-WASKO" -DomainMail "de2es.pl"
    Set-CredentialMxCoig -Target "mxde2es"
    Get-AddNewAccountSmarterMail -enableMailForwarding "false"
    ...
    Get-CheckInputData
    Get-ChoiseManagerInOrganizationUnit -Server "wasko.pl" -pathOU "OU=WASKO, DC=wasko, DC=pl"
    Get-AddNewUser -StreetAddress "Pańska 23" -City "Kraków" -Company "D2S sp. z o.o." -PostalCode "30-565" -Server "wasko.pl" -Department "D2S" -Server "wasko.pl" -DomainMail "de2es.pl" -Description "D2S, $Firstname $Lastname" -mainPath "$mainpath"
    Get-AddUserToGroupMember
    Get-WriteToFileNewUsersList -Domain "DOMENA-WASKO" -DomainMail "de2es.pl"
    Set-CredentialMxCoig -Target "mxde2es"
    Get-AddNewAccountSmarterMail -enableMailForwarding "false"
    ...
    Get-AddNewUser -Server "win.gabos.pl" -DomainMail "gabos.pl" -Description "$Department/$Firstname $Lastname" -mainPath "$mainpath"
    Get-AddUserToGroupMember
    ...
    Get-AddNewUser -StreetAddress "Berbeckiego 6" -City "Wasko - Centrala Gliwice" -Company "WASKO4BUSINESS SP. Z O.O." -PostalCode "44-100" -Server "fk.wasko.pl" -DomainMail "wasko4b.pl" -Department "$Department" -Description "$Department, $Firstname $Lastname" -mainPath "$mainpath" -Office "Pracownicy Wasko"
    Get-AddUserToGroupMember
    ...
    Get-CheckInputData
    Get-ChoiseManagerInOrganizationUnit -Server "fk.wasko.pl" -pathOU "OU=W4B, OU=Wspolpracownicy, OU=WASKO, DC=fk, DC=wasko, DC=pl"
    Get-AddNewUser -StreetAddress "Mikołowska 100" -City "Katowice" -Company "WASKO4BUSINESS SP. Z O.O." -PostalCode "40065" -Server "fk.wasko.pl" -DomainMail "wasko4b.pl" -Department "$Department" -Description "$Department, $Firstname $Lastname" -Office "Pracownicy Wasko" -mainPath "$mainpath"
    Get-AddUserToGroupMember
    Get-WriteToFileNewUsersList -Domain "FK" -DomainMail "wasko4b.pl"
    Set-CredentialMxCoig -Target "mxwasko4b"
    Get-AddNewAccountSmarterMail -enableMailForwarding "false"
